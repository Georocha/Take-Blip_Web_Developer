function start() {
    ...
    $("#fundoGame").append("<div id='inimigo2' class='animacao5'></div>");
    ...
    function explosao3(amigoX,amigoY) {
        ...
        somPerdido.play();
        $("#fundoGame").append("<div id='explosao3' class='animacao4'></div");
    ...
    function gameOver() {
        ...
        $("#fundoGame").append("<div id='fim'></div>"); 
         $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><input type=button value='Jogar Novamente' class='btnReset' /></div>");
    }
}
